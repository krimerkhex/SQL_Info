...
call CheckP2P('John', 'Alice', 'Task2', 'Start', current_date);
call CheckVerter('Alice', 'Task2', 'Success', '10:00:00');
insert into P2P (CheckId, CheckingPeer, status, Time)
value (2, 'Alice', 'Start', '14:00:00');
insert into XP (CheckId, XPAmount)
values (2, 3);

select * from xp

call CheckP2P('John', 'Alice', 'Task1', 'Start', '10:00:00');
call CheckP2P('Mike', 'Emily', 'Task1', 'Start', '13:00:00');

call CheckVerter('John', 'Task1', 'Start', '11:00:00');
call CheckVerter('Mike', 'Task1', 'Success', '14:00:00');

insert into p2p(checkid, checkingpeer, status, time)
values (3, 'Alice', 'Start', '16:00:00');