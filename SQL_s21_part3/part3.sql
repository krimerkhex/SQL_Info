...
create or replace procedure DetermiteForEachMonthThePercentageOfEarlyEntries()
language plpgsql
as $$
  begin
    ...
    perform get_month_name(tmp.entry_month) as month, (tmp2.count * 100 / tmp.count) as early_entries_percent
    from (
...
call DetermiteForEachMonthThePercentageOfEarlyEntries();
